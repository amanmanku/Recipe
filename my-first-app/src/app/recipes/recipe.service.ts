...
export class RecipeService {
    ...
    public recipes: Recipe[] = [
        new Recipe('Fruit', 'Fruit Salad', FRUIT, new Ingredient('Apple', 3)),
        new Recipe('Baguette', 'Italic Bread', BAGUETTE, new Ingredient('Water', 100)),
        new Recipe('Pasta', 'With Salad', PASTA, new Ingredient('Vegetables', 3)),
        new Recipe('Soup', 'Tasty & Hot', SOUP, new Ingredient('Water', 3)),
        new Recipe('Pie', 'Pretty & Attractive', PIE, new Ingredient('Power', 10)),
        new Recipe('Popsicle', 'Cold & Refreshing', POPSICLE, new Ingredient('Fruits', 5))
    ];
    ...
    addIngredientsToShoppingList(ingredients: Ingredient) {
        if (ingredients = null) {
            ...
            ingredients = new Ingredient('Apple', 3);
            ingredients = new Ingredient('Vegetables', 3);
        }
